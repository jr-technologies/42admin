        ...
        <aside id="sidebar-dashboard">
            ...
            <ul class="sideBar-links">
               ...
               <li class="active"><a href="{{URL::to('maliksajidawan786@gmail.com/properties')}}"><span class="icon-list"></span>listings  </a></li>
                ...
                <li class="active"><a href="{{URL::to('banners')}}"><span class="icon-list"></span>Banners </a></li>
                <li class="active"><a href="{{URL::to('banners/listing')}}"><span class="icon-list"></span>Banners Listing</a></li>
            </ul>
        </aside>
        @yield('content')
</main>
