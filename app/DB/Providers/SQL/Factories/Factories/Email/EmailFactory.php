...
namespace App\DB\Providers\SQL\Factories\Factories\Email;

use App\DB\Providers\SQL\Factories\Factories\Email\Gateways\EmailQueryBuilder;
...
class EmailFactory extends SQLFactory implements SQLFactoriesInterface{
    private $tableGateway = null;
    public function __construct()
    {
        $this->tableGateway = new EmailQueryBuilder();
    }
