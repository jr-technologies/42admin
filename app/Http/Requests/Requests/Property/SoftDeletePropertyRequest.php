...
use App\Http\Validators\Validators\PropertyValidators\SoftDeletePropertyValidator;
...
use App\Transformers\Request\Property\SoftDeletePropertyTransformer;
use App\Transformers\Request\Property\VerifyPropertyTransformer;


class SoftDeletePropertyRequest extends Request implements RequestInterface{

    public $validator = null;
    private $properties = null;

    public function __construct(){
        parent::__construct(new SoftDeletePropertyTransformer($this->getOriginalRequest()));
        $this->validator = new SoftDeletePropertyValidator($this);
