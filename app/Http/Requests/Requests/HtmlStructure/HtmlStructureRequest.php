...
class HtmlStructureRequest extends Request implements RequestInterface{

    public $validator = null;
    public function __construct(){
        parent::__construct(new HtmlStructureTransformer($this->getOriginalRequest()));
        $this->validator = new HtmlStructureValidator($this);
    }
